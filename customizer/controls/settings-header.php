...
$wp_customize->add_setting('complete[header_mobile_number]', array(
	'type' => 'option',
	'default' => __('<img src="'.get_template_directory_uri().'/images/phone-icon.png"><span class="header-phone"><small>NEED HELP?</small>123 - 456 - 7890</span>','complete'),
...
//Header social icons
$wp_customize->add_setting('complete[header_social_icons]', array(
	'type' => 'option',
	...
	'transport' => 'postMessage',
			...
			$wp_customize->add_control(	new WP_Customize_Textarea_Control( $wp_customize, 'header_social_icons', array( 
				'type' => 'textarea',
				'label' => __('Header Social Icons','complete'), 
				'section' => 'headheader_section',
				'settings' => 'complete[header_social_icons]',
			)) );
