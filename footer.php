<?php 
/**
 * The Footer for SKT Ele Icecream Lite
 *
...
<div id="footer" class="footer-type<?php echo $footertype; ?>">
	<div class="center">
    	...
    	<div class="rowfooter<?php if ($footertype == 5) {?> footernone<?php } ?>">
			...
			<?php if (!empty ($complete['footer_menu_area'])) { ?>
            <?php $phntp7 = html_entity_decode($complete['footer_menu_area']); $phntp7 = stripslashes($phntp7); echo do_shortcode($phntp7); ?>
            <?php } ?>
          </div>
    </div>
</div>
